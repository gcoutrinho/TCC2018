...
namespace TccUsjt2018.Migrations
{
    ...
    [Migration("20181014230134_tabelaDeBaixaDeLote")]
    partial class tabelaDeBaixaDeLote
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("TccUsjt2018.Database.Entities.Baixa", b =>
                {
                    ...
                    b.Property<int>("Lote_CodigoLote");

                    b.Property<int>("Produto_CodigoProduto");

                    b.Property<int>("QuantidadeBaixa");

                    b.HasKey("CodigoBaixa");
                });
            ...
            modelBuilder.Entity("TccUsjt2018.Database.Entities.Baixa", b =>
                {
                    b.HasOne("TccUsjt2018.Database.Entities.Lote")
                        .WithMany()
                        .HasForeignKey("Lote_CodigoLote");
